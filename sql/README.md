# Introduction
This project was done in order to get more familiar with SQL queries and RDBMS.

## Who are the users?
The users of this project is for anyone that would like to practice SQL queries with the sample database. Queries include SELECT, INSERT, CREATE, DELETE amongst others.
...
create table if not exists cd.bookings(
	...
	constraint pk_bookings primary key(facid),
...
```
psql -U <username> -f clubdata.sql -d <database_name> -x -q
```
## Answers
```
